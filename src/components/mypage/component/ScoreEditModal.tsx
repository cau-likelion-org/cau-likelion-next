      ...
      <Wrapper>
        <Header>
          <Title>
            출결사항 수정
            <span>
              [{TRACK_NAME[targetUserScore.track]}] {targetUserScore.name}
            </span>
          </Title>
        ...
        <FormWrapper>
          <ScoreWrapper>
            ...
            <ScoreRow>
              <Score>
                <ScoreInput value={absenceValue} onChange={onChangeAbsenceValue} />
              </Score>
              <Score>
                <ScoreInput value={truancyValue} onChange={onChangeTruancyValue} />
              </Score>
              <Score>
                <ScoreInput value={tardinessValue} onChange={onChangeTardinessValue} />
              </Score>
