...
interface IProps {
  ...
  accessTokenOnce: string;
  refreshTokenOnce: string;
}

const CauMailAuthenticationBox = ({
  title,
  emailValue,
  onChangeEmail,
  secretValue,
  ...
  return (
    <RowContainer>
      ...
      {isEmailModalOn && <EmailModal email={emailValue} setIsEmailModalOn={setIsEmailModalOn} />}
      {isErrorModalOn && <EmailErrorModal setIsErrorModalOn={setIsErrorModalOn} />}
    </RowContainer>
  );
};
